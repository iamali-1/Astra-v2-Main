...
const CreateBlog = () => {
  ...
  const { loading, createBlog, changeHandler, _setValues, _values } = _useBlogs();
  ...
  const handleSubmit = (e) => {
    ...
    createBlog(_formData);
  };

  return (
    <Layout>
      <Breadcrumbs current={"Create Blog"} currentIcon={<MdCreate />} />
      <PanelHeading title={"Create Blog"} para={"Using responsive utility variants to build adaptive user interfaces."} />
